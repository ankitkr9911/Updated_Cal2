...
arr.forEach(button => {
    button.addEventListener("click", (e) => {
        ...
        else if (e.target.innerHTML == "sin" || e.target.innerHTML == "cos" || e.target.innerHTML == "tan" || e.target.innerHTML == "log" || e.target.innerHTML == "CBRT" || e.target.innerHTML == "SQRT" || e.target.innerHTML == "ceil" || e.target.innerHTML == "floor") {
